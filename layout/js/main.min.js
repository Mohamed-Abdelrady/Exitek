...
document.onreadystatechange = function() {
    if (document.readyState !== "complete") {
        ...
        if (document.querySelector('.typescript_heading')) {
...
function SubmitForm() {
    ...
    if (
        ...
        $.ajax({
            type: "POST",
            url: "https://docs.google.com/forms/u/0/d/e/1FAIpQLSes4uNRjwxZ_aY5qJo5Ol7k6KLKeZTXT8WC91_sKQUStKQmRw/formResponse",
            data: e,
            async: !1,
            dataType: "xml",
            success: function(e) {
...
function SuccessResponse() {
    ...
    $("#email").val("");
    $("#message").val("");
    $("#contact-form .input-field").removeClass("invalid");
    $("#contact-form .input-field").removeClass("not-empty");

}
// validate inputs
$('#contact-form .form-input').blur(function(e) {
    if(e.target.id == "name") {
        validateName();
    }
...
$(".open-position .btn").on("click", function(e){
